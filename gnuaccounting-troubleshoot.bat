...
echo     Located JRE %jre_Version%
echo     located has been set to:
echo         %Located%
...
echo     Could not locate JRE %JRE_Version%
pause
...
"%JAVA_HOME%\bin\java" -Djava.library.path=.\libs -cp ".\libs\swt\swt.jar;.\libs\swt\org.eclipse.core.commands-3.12.100.jar;.\libs\swt\org.eclipse.equinox.common-3.19.100.jar;.\libs\swt\org.eclipse.jface-3.34.0.jar;.\libs\swt\org.eclipse.osgi-3.20.0.jar;.\libs\swt\org.eclipse.swt.win32.win32.x86_3.104.2.v20160212-1350.jar;.\libs\swt\org.eclipse.swt_3.104.2.v20160212-1350.jar;.\libs\noa\noa-libre.jar;.\libs\noa\junit-3.8.1.jar;.\libs\noa\ridl.jar;.\libs\noa\bootstrapconnector.jar;.\libs\noa\jurt.jar;.\libs\noa\sandbox.jar;.\libs\noa\java_uno_accessbridge.jar;.\libs\noa\jut.jar;.\libs\noa\unoil.jar;.\libs\noa\officebean.jar;.\libs\noa\unoloader.jar;.\libs\noa\juh.jar;.\libs\noa\registry-3.1.3.jar;.\libs\mail.jar;.\libs\hbci\hbci4java.jar;.\libs\barcode-google-zxing-2_2_core.jar;.\libs\barcode-google-zxing-2_2_javase.jar;.\libs\uk.co.mmscomputing.device.sane.jar;.\libs\uk.co.mmscomputing.device.twain.jar;.\libs\PDFRenderer.jar;.\libs\persistence\derby-10.14.2.0.jar;.\libs\persistence\hsqldb-2.7.3.jar;.\libs\persistence\eclipselink-2.6.9.jar;.\libs\persistence\javax.persistence-api-2.2.jar;.\libs\persistence\mysql-connector-j-9.0.0.jar;.\libs\persistence\postgresql-42.7.3.jar;.\libs\jargs.jar;.\libs\ical\commons-codec-1.3.jar;.\libs\ical\commons-logging-1.1.1.jar;.\libs\ical\ical4j-vcard-0.9.5.jar;.\libs\ical\backport-util-concurrent-3.1.jar;.\libs\ical\commons-lang-2.4.jar;.\libs\ical\gmaven-common-1.0-rc-5.jar;.\libs\ical\gmaven-feature-api-1.0-rc-5.jar;.\libs\ical\gmaven-feature-support-1.0-rc-5.jar;.\libs\ical\gmaven-runtime-1.6-1.0-rc-5.jar;.\libs\ical\gmaven-runtime-api-1.0-rc-5.jar;.\libs\ical\gmaven-runtime-support-1.0-rc-5.jar;.\libs\ical\ical4j-1.0.3.jar;.\libs\pdfbox-1.8.2.jar;.\libs\preflight-app-1.8.2.jar;.\libs\xmpbox-1.8.2.jar;.\libs\json-simple-1.1.1.jar;.\libs\tesseract-ocr\tess4j.jar;.\libs\tesseract-ocr\ghost4j-0.3.1.jar;.\libs\tesseract-ocr\jai_imageio.jar;.\libs\tesseract-ocr\jna.jar;.\libs\tesseract-ocr\junit-4.10.jar;.\libs\mustang-1.3.1.jar;.;libs\jaxb-api-2.3.1.jar" GUILayer/MainWindow %*
pause
